...
@Composable
fun InicioSinCitasScreen(navController: NavHostController) {
    ...
    Box(modifier = Modifier.fillMaxSize().background(azulFondo)) {
        ...
        Image(painter = painterResource(id = R.drawable.logo), contentDescription = null, modifier = Modifier.fillMaxSize().offset(y = (-200).dp).alpha(0.05f), contentScale = ContentScale.Fit)
        ...
        Column(
            ...
            Text(text = fechaActual, fontSize = 16.sp, color = Color.Black)
            Spacer(modifier = Modifier.height(45.dp))

            Text(text = "No tienes citas agendadas para hoy", fontSize = 18.sp, fontWeight = FontWeight.Bold, textAlign = TextAlign.Center)
